...
export default function HomeLoan() {
  ...
  const handleDownloadPDF = () => {
    const reportData = {
      ...
      filename: 'home-loan-report.pdf',
      summary: { label: 'Estimated Monthly EMI', value: `₹${emiData.monthlyPayment.toLocaleString('en-IN')}` },
      inputs: [
        { label: 'Property Value', value: `₹${propertyValue.toLocaleString('en-IN')}` },
        { label: 'Down Payment', value: `₹${downPayment.toLocaleString('en-IN')}` },
        { label: 'Loan Amount Required', value: `₹${loanAmount.toLocaleString('en-IN')}` },
      ...
      results: [
        ...
        { label: 'Total Cost of Acquisition (Down Payment + Total Loan Cost)', value: `₹${(downPayment + emiData.totalPayment).toLocaleString('en-IN')}` },
        { label: 'Total Loan Payment (Principal + Interest)', value: `₹${emiData.totalPayment.toLocaleString('en-IN')}` }
      ]
    };
