...
export function calculateSIP(monthlyInvestment, expectedReturn, tenureYears) {
...
export function calculateLoanEligibility(grossIncome, existingEmi, annualRate, tenureYears, foirPercent = 50 // Fixed Obligation to Income Ratio
) {
...
export function calculateFD(principal, ratePercent, tenureYears, compounding) {
...
export function calculateGST(amount, ratePercent, type) {
...
export function calculateRetirement(currentAge, retirementAge, currentMonthlyExpenses, currentSavings, inflationRate, preRetirementReturn, postRetirementReturn, lifeExpectancy) {
...
export function calculateSavingsGoal(targetAmount, years, expectedReturn, initialSavings = 0) {
...
export function calculateTDS(sectionCode, paymentAmount, panAvailable, isCompany, isNri) {
...
export function calculateImportDuty(cifValue, freight, insurance, bcdRate, igstRate, swsRate = 10, // Social Welfare Surcharge (10% standard)
antiDumpingRate = 0, safeguardRate = 0, compensationCessRate = 0) {
...
export function calculateExportDuty(productValue, shippingCost, insuranceCost, dutyRate, taxRate, incentiveRate, // Government incentives like RoDTEP/MEIS
costOfProduction) {
...
export function calculateSalary(grossMonthly, pfEmployeeRate = 12, ptAmount = 200) {
...
export function calculateInflation(amount, years, inflationRate, direction) {
